...
<script type="text/javascript">
    ...
    var mediaDropZone = $(".dropzone.default").dropzone({
        ...
        removedfile: function (file) {
            ...
            $.post("{!! url('console/uploads/clear') !!}",
                {
                    _token: '{!! csrf_token() !!}',
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function initSelectCollection() {
            ...
            $.ajax({
                url: "{!! url('console/uploads/collectionsNames') !!}",
                type: 'GET',
        ...
        function loadMedia(url) {
            ...
            $.ajax({
                ...
                error: function (data, status, error) {
                    console.log('url: ' + url + '; error: ' + JSON.stringify(data));
                    mediaItems.find('.card.loader').html('Error please refresh page or use (Ctrl+F5)');
                },
        ...
        $('#mediaModal #refreshMedia').on('click', function () {
            loadMedia("{!! url('console/uploads/all') !!}/default");
        ...
        $('#selectCollection #collectionName').on('change', function () {
            loadMedia("{!! url('console/uploads/all') !!}/" + $(this).val());
        });

...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Image Field -->
    <div class="form-group row">
      {!! Form::label('imgInp', trans("lang.author_image"), ['class' => 'col-3 control-label text-right']) !!}
      <div class="col-9">
    ...
    <!-- Description Field -->
    <div class="form-group row ">
        {!! Form::label('description', trans("lang.author_description"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
             trans("lang.author_description_placeholder")  ]) !!}
        </div>
    </div>
</div>
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}}" ><i class="fa fa-save"></i> {{trans('lang.save')}} {{trans('lang.author')}}</button>
  <a href="{!! route('authors.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>

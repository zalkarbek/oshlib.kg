        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    ...
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.book_create')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                {!! Form::open(['url' => url('books/create-from-json'), 'enctype' => 'multipart/form-data', 'method' => 'POST']) !!}
                <div class="row">
                    <div style="flex: 100%; max-width: 100%;padding: 0 4px;" class="column">
                        <!-- Description Field -->
                        <div class="form-group row ">
                            {!! Form::label('json', 'JSON', ['class' => 'col-3 control-label text-right']) !!}
                            <div class="col-9">
                                {!! Form::textarea('json', null, ['class' => 'form-control','placeholder'=> 'JSON' ]) !!}
                            </div>
                        </div>
                    </div>
                    <!-- Submit Field -->

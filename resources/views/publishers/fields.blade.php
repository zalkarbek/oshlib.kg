<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
      {!! Form::label('name', trans("lang.publisher_name"), ['class' => 'col-3 control-label text-right']) !!}
      <div class="col-9">
        {!! Form::text('name', null,  ['class' => 'form-control','placeholder'=>  trans("lang.publisher_name_placeholder")]) !!}
        <div class="form-text text-muted">
          {{ trans("lang.publisher_name_help") }}
        </div>
      </div>
    </div>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    <!-- Image Field -->
    <div class="form-group row">
      {!! Form::label('imgInp', trans("lang.publisher_image"), ['class' => 'col-3 control-label text-right']) !!}
      <div class="col-9">
        ...
        <div class="form-text text-muted w-50">
          {{ trans("lang.publisher_image_help") }}
        </div>
      </div>
    </div>
    @prepend('scripts')
    ...
    <!-- Description Field -->
    <div class="form-group row ">
        {!! Form::label('description', trans("lang.publisher_description"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
             trans("lang.publisher_description_placeholder")  ]) !!}
        </div>
    </div>
</div>
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('publishers.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>

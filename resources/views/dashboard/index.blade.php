    ...
    <div class="content">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        ...
                        <p>{{trans('lang.total_users')}}</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-group"></i>
                    </div>
                    <a href="{!! url('console/users') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header no-border">
                        <h3 class="card-title">{{trans('lang.advertisement_plural')}}</h3>
